...
// directly). embedWorkingStatus defaults OFF: the Working line lives in the
// above-editor widget (see chrome/working.ts), never inside the border.
// Intentionally no per-line '›' prefix: the Editor render pipeline has no
// safe per-line hook (deliberate Codex deviation, see VALIDATION.md).
